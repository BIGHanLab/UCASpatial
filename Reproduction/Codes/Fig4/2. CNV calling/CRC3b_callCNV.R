...
NC_CRC3b_infCNV <- infercnv::CreateInfercnvObject(raw_counts_matrix="./CRC3b_count_matrix.tsv",
                                                 gene_order_file="./siCNV_GeneOrderFile.tsv",
                                                 annotations_file="./Region_CRC3b.tsv",
                                                 delim="\t",
                                                 ref_group_names="Remaining",
                                                 chr_exclude = c("chrM","chrX","chrY"))
saveRDS(NC_CRC3b_infCNV,file="./CRC3b_infCNV_clone_group_2.RDS")

#Run inferCNV
NC_CRC3b_infCNV_res_spot = infercnv::run(NC_CRC3b_infCNV,
                                        cutoff=0.1, #(see infercnv::run documentation)
                                        out_dir="./SPCNVoutputs_CRC3b_clone_group_2",
...
saveRDS(NC_CRC3b_infCNV_res_spot,file="./CRC3b_infCNV_clone_group_2_res_cluster_level_3.RDS")