...
NC_CRC5_infCNV <- infercnv::CreateInfercnvObject(raw_counts_matrix="./CRC5_count_matrix.tsv",
                                                 gene_order_file="./siCNV_GeneOrderFile.tsv",
                                                 annotations_file="./Region_CRC5.tsv",
                                                 delim="\t",
                                                 ref_group_names="Remaining",
                                                 chr_exclude = c("chrM","chrX","chrY"))
saveRDS(NC_CRC5_infCNV,file="./CRC5_infCNV_clone_group_2.RDS")

#Run inferCNV
NC_CRC5_infCNV_res_spot = infercnv::run(NC_CRC5_infCNV,
                                        cutoff=0.1, #(see infercnv::run documentation)
                                        out_dir="./SPCNVoutputs_CRC5_clone_group_2",
...
saveRDS(NC_CRC5_infCNV_res_spot,file="./CRC5_infCNV_clone_group_2_res_cluster_level_3.RDS")